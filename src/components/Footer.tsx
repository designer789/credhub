        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-600 max-w-xs">
              Next-generation decentralized reputation protocol for Web3 ecosystems.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="font-general font-semibold text-lg mb-6">Quick Links</h3>
          ...
          {/* Connect */}
          <div>
            <h3 className="font-general font-semibold text-lg mb-6">Connect</h3>
            <ul className="space-y-3">
              <li>
                <a 
                  href="https://t.me/Cred_Hub" 
